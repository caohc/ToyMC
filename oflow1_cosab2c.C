void flow1_cosab2c()
{
TFile* in_file= new TFile("7_Eta3_psi=0.root");
...
allcos1_cosab2c->GetYaxis()->SetTitle("cos(#alpha+#beta-2c)");
...
dif ->Add(hallcos1_cosab2cdiff,hallcos1_cosab2csame,1,-1);
dif ->SetTitle("hallcos1_cos(a+b-2c) UL-LS");
dif ->Draw();
...
dif ->Add(hallcos2_cosab2cdiff,hallcos2_cosab2csame,1,-1);
dif ->SetTitle("hallcos2_cos(a+b-2c)UL-LS");
dif ->Draw();
